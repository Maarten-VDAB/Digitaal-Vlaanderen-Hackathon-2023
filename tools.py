...
class RAGTool(BaseTool):
    ...
    name = "SearchAirportKnowledgeBase"
    description = (
        "useful for when you need to answer general questions about Brussels Airport."
        ...
        "the context you'll be using is either based on shops and restaurant info, or general info."
